...
export ANDROID_NDK_ROOT=/root/android-ndk-r16b
...
export LD="$AOSP_TOOLCHAIN_PATH/$TOOLNAME_BASE-ld"
...
./configure --prefix=$PREFIX --host=$TOOLNAME_BASE --enable-static --enable-shared
